...
Citizen.CreateThread(function()
    while true do
        ...
        if isLoggedIn then
            if (PlayerJob ~= nil) and PlayerJob.name == "pdmowner" then
        ...
        if isLoggedIn then
            if dist < 2 then
                if PlayerJob ~= nil then
                    if PlayerJob.name == "pdmowner" or PlayerJob.name == "pdmceo" or PlayerJob.name == "pdmmanager" then
                        ...
                        DrawText3Ds(QBCustom.ShowroomPositions[ClosestCustomVehicle].coords.x, QBCustom.ShowroomPositions[ClosestCustomVehicle].coords.y, QBCustom.ShowroomPositions[ClosestCustomVehicle].coords.z + 1.75, '~b~/sellv [id]~w~ - Sell vehicle ~b~/testdrive~w~ - Try vehicle')
                    end
